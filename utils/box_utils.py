...
def bbox_count(pred_boxes, target_boxes, iou_threshold=0.5):
    """
    Compute the bounding box accuracy using IoU threshold.
    """
    ious = bbox_iou(pred_boxes, target_boxes, False)
